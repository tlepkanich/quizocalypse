...
const S: Record<string, React.CSSProperties> = {
  ...
  matched: { fontSize: 13, fontWeight: 700, color: "#5B45D6", margin: "0 0 10px", letterSpacing: ".01em" },
  lede: { fontSize: 18, lineHeight: 1.55, color: "#3f3b34", maxWidth: 720 },
  cta: { display: "inline-block", marginTop: 10, background: "#5B45D6", color: "#fff", padding: "12px 22px", borderRadius: 12, textDecoration: "none", fontWeight: 700 },
