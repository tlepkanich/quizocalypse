import type { Quiz as QuizDoc, QuizNode, Answer } from "./quizSchema";
...
// One option in the "Skip to" dropdown (relocated from AnswerRow — the shape
// is shared by the legacy answer row and the v3 answers table).
