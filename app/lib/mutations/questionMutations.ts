      ...
      n.id === nodeId && n.type === "question"
        ? {
            ...
            data: {
              ...
              answers,
              // Multi-select deciders retain their role. Preserve historical
              // type-change behavior for legacy docs; freeform still demotes.
              ...(((doc.logic_model !== "decider" && newType === "multi_select") || isFreeformType(newType)) &&
              n.data.role === "decides"
