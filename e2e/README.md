...
| `qwidget-verify.mjs` | WIS-026 mapping replacement, staged Cancel, role preservation, multi-select publish/public union, 200-item responsive tray | LOCAL build + `cmr7khgd5…` | draft/published/version/status/category snapshot → restore |
